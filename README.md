...
-->
# IP Address Decision Authentication Node</b>

A simple authentication node for ForgeRock's [Identity Platform][forgerock_platform] 5.5 and above. This node checks if incoming request IP address matches against the configurable list - useful for bot-protection or malicious node detection.  Can be switchable to either black or white list.
## Installation
