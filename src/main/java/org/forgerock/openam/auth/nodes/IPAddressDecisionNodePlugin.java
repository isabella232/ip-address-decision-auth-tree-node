 ...
 */
public class IPAddressDecisionNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public IPAddressDecisionNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
